...
//@@@ TODO: these TESTS are 100% the same as the exclusive_or_register but I needed to make
//tests for this in case I swap those to take actual register values, i haven't decided yet,
//will do in main loop. Point is this is here for now incase I make changes to that later
