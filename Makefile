...
MAIN_SRCS = src/logic.c src/flags.c src/cpu.c src/main.c  src/arith.c src/data.c src/helpers.c 
MAIN_OBJS = $(MAIN_SRCS:.c=.o)

HELPERS_MAIN_SRCS = src/logic.c src/flags.c src/cpu.c src/arith.c src/data.c src/helpers.c
HELPERS_OBJS = $(HELPERS_MAIN_SRCS:.c=.o) 
TEST_SRCS = test/test_flags.cpp test/test_interg_arth.cpp test/test_logic.cpp test/test_data.cpp test/test_helpers.cpp
